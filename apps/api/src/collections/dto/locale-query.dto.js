...
var LocaleQueryDto = function () {
    var _a;
    var _locale_decorators;
    var _locale_initializers = [];
    var _locale_extraInitializers = [];
    return _a = /** @class */ (function () {
            function LocaleQueryDto() {
                this.locale = __runInitializers(this, _locale_initializers, 'pt-BR');
                __runInitializers(this, _locale_extraInitializers);
            }
            return LocaleQueryDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _locale_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsIn)(['pt-BR', 'en', 'es'])];
